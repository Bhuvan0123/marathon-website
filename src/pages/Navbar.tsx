...
import side_logo from "../assets/logo/left_text_logo.png" 
  ...
  return (
    <>
        ...
        {visible && (
          ...
          >
            <div className="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center">
              <img src={side_logo} alt="Marathon Logo" className="ml-4 h-12 w-auto" />
              <div className="flex space-x-6 text-gray-700 font-medium text-xl">
                {navLinks.map((link) => (
      ...
      <div className="md:hidden fixed top-0 left-0 w-full bg-gradient-to-r from-yellow-100 via-orange-100 to-red-100 shadow-md z-50 flex items-center px-4 py-3">
        ...
        <img src={side_logo} alt="Marathon Logo" className="ml-4 h-8 w-auto" />
      </div>
