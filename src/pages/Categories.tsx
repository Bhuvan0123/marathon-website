...
export default function Categories() {
  ...
  return (
    <section id="category" className="mt-10 p-12 bg-amber-500 ">
      ...
      <div className="flex flex-row justify-center gap-20 mt-15 md:flex-nowrap flex-wrap">
        <PopoverRoot>
          <PopoverTrigger className="w-auto h-auto p-5 rounded-lg shadow-md bg-orange-100 text-orange-900 flex flex-col justify-between sm:h-auto sm:w-100">
            <div>
          ...
          <PopoverContent className="w-auto h-auto p-4 rounded-lg shadow-lg bg-yellow-100 text-yellow-900">
              <h2 className="text-xl font-bold text-center mb-2 sm:w-110">
                Men Category - Prizes
              </h2>
