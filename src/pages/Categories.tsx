  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center mb-16">
        <div className="opacity-100 max-w-5xl mb-10 w-full rounded-3xl p-0 md:p-0 shadow-2xl bg-gradient-to-br from-orange-50 via-yellow-50 to-orange-100 flex flex-col md:flex-row items-stretch border border-orange-200 overflow-hidden md:mb-0">
          {/* Left: Event Logo */}
          ...
          <div className="flex-1 flex flex-col justify-center items-start p-8 md:p-12 ">
            ...
            <ul className="text-lg md:text-xl text-orange-800 space-y-4 mb-4 w-full">
              ...
              <li className="flex flex-col md:flex-row md:items-center gap-1 md:gap-2">
                ...
                <span className="text-orange-700 ml-7 md:ml-1">
                  Vellore Old Bus Stand <span className="font-bold">to</span>{" "}
                  Sri Narayani Schools
                </span>
              </li>
            </ul>
      ...
      <div className="flex flex-wrap justify-center gap-10 mb-16">
        ...
        <PopoverRoot>
          ...
          <PopoverContent className="w-auto max-w-sm h-auto p-6 mb-10  rounded-xl shadow-lg bg-yellow-100 text-yellow-900 md:w-200 md:mb-0">
        ...
        <PopoverRoot>
          ...
          <PopoverContent className="w-auto max-w-sm h-auto mt-20 p-6 rounded-xl shadow-lg bg-yellow-100 text-yellow-900 md:w-100 md:mt-0">
      ...
      <div className="flex flex-col items-center mt-10 w-full">
        <h2 className="mb-6 mt-15 text-3xl font-bold text-orange-900 text-center md:mt-0">
